...
class SurpriseCreator {
                    ...
                    <div class="flex items-center justify-between">
                        <div class="flex items-center">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-gray-600">Effets: ${template.effects.join(', ')}</p>
                            </div>
                        </div>
                        <div class="flex space-x-2">
    ...
    changeTemplate(templateKey) {
        ...
        this.surprise.effects = template.effects;
                ...
                // Mettre à jour l'affichage en re-rendant l'étape 1
    ...
    async saveSurprise() {
        ...
        try {
            ...
            // Indiquer au dashboard qu'une surprise a été créée
            localStorage.setItem('surpriseCreated', 'true');
    ...
    async downloadQRCode() {
        ...
        if (!qrContainer) {
            ...
            try {
                // Capture the QR code content using html2canvas
                const qrCodeCanvas = await html2canvas(qrContainer, {
                    useCORS: true, // Needed if QR Code uses external images (e.g., from qrserver.com fallback)
            ...
            // Dessiner le QR Code capturé par html2canvas
