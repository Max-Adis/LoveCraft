...
class DashboardManager {
    ...
    async init() {
        onAuthStateChanged(auth, async (user) => {
            ...
            // Check for surprise creation success notification
            if (localStorage.getItem('surpriseCreated')) {
                this.showNotification('🎉 Votre surprise a été créée avec succès !');
                localStorage.removeItem('surpriseCreated');
            }
        });
    }
